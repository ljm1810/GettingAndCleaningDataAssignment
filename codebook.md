Codebook
========
Codebook was generated on 2015-03-21 12:37:47 during the same process that generated the dataset. See `run_analysis.md` for details on dataset creation.
...
Save data table objects to a tab-delimited text file called `new_dataset.txt`.


```r
f <- file.path(path, "new_dataset.txt")
